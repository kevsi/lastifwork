 ...
 */
final class Version20250424111515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categories ADD code VARCHAR(10) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_3AF3466877153098 ON categories
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categories DROP code
        SQL);
    }
}
